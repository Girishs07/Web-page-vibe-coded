...
import { Target, Users, Zap, Shield, Award, Truck, Factory, Globe } from 'lucide-react';
...
const About = () => {
  ...
  const milestones = [
    {
      ...
      description: "MD & CO established as a premium salt distributor in Gujarat"
    },
    {
      year: "2000",
      title: "Expansion Begins",
      description: "Extended operations to neighboring states with increased production capacity"
    },
    {
      year: "2010",
      title: "National Presence",
      description: "Achieved nationwide distribution network covering 15+ states"
    },
    {
      year: "2020",
  ...
  const stats = [
    ...
    { icon: Truck, number: "500+", label: "Monthly Deliveries" },
    { icon: Factory, number: "4", label: "Manufacturing Units" },
    { icon: Globe, number: "15+", label: "States Covered" }
  ];
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From a small regional distributor to India's leading salt supplier, 
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Why Choose MD & CO?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our commitment to quality, reliability, and customer satisfaction sets us apart 
              in the salt distribution industry.
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl mb-8 opacity-90">
              Join thousands of satisfied customers who trust MD & CO for their salt requirements.
            </p>
